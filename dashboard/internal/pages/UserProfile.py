...
def main():
    ...
    html_str = html_str + '<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Username" value="' + username + '">'
    html_str = html_str + '</div>'
    html_str = html_str + '<div class="form-group">'
    html_str = html_str + '<input type="email" name="email" id="email" tabindex="1" class="form-control" placeholder="Email Address" value="'+ email  + '">'
    html_str = html_str + '</div>'
    html_str = html_str + '<div class="form-group">'
    html_str = html_str + '<input type="password" name="password" id="password" tabindex="2" class="form-control" placeholder="Password">'
    html_str = html_str + '</div>'
    html_str = html_str + '<div class="form-group">'
    html_str = html_str + '<input type="password" name="confirm-password" id="confirm-password" tabindex="2" class="form-control" placeholder="Confirm Password">'
    html_str = html_str + '</div>'
    html_str = html_str + '<div class="form-group">'
    html_str = html_str + '<input type="text" name="phone" id="phone" tabindex="2" class="form-control" placeholder="Phone #" value="' + phone + '">'
    html_str = html_str + '</div>'
    html_str = html_str + '<div class="form-group">'
