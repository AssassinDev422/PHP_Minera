...
def main():
    ...
    try:
        sid = sys.argv[1]
        idstr = sys.argv[2]
        user = requests.get('http://api.msunicloud.com:2404/users/' + idstr, cookies={'sid':sid}).json()
    ...
    if total != float(0):
        ...
        btcearnings = 0
    html_str = html_str +  '<div class="huge">' + str( "{0:.8f}".format(round(btcearnings,2)) )+ '</div>'
    html_str = html_str +  '<div>Bitcoin</div>'
    html_str = html_str +  '</div>'
    html_str = html_str +  '</div>'
    html_str = html_str +  '</div>'
    html_str = html_str +  '<a href="/dashboard/internal/pages/orders.php?sid=' + sid + '">'
    ...
    if total == float( 0 ):
        ...
        ltcearnings = 0
    html_str = html_str +  '<div class="huge">' + str( "{0:.8f}".format(round(ltcearnings,2)) )+ '</div>'
    ...
    html_str = html_str +  '<div class="huge">' + str( "{0:.8f}".format(round(dashearnings,2)) )+ '</div>'
    ...
    if total != float(0):
        ...
        ethearnings = float(0)
    html_str = html_str +  '<div class="huge">' + str( "{0:.8f}".format(round(ethearnings,2)) )+ '</div>'
    ...
    html_str = html_str +  '<a href="#">'
    html_str = html_str +  '<div class="panel-footer">'
    html_str = html_str +  '<span>' + str(user['dashaddress']) + '</span>'
    html_str = html_str +  '<div class="clearfix"></div>'
    html_str = html_str +  '</div>'
    html_str = html_str +  '</a>'
    html_str = html_str +  '</div>'
    ...
    html_str = html_str +  '<a href="#">'
    html_str = html_str +  '<div class="panel-footer">'
    html_str = html_str +  '<span>' + str(user['ethaddress']) + '</span>'
    html_str = html_str +  '<div class="clearfix"></div>'
    html_str = html_str +  '</div>'
    html_str = html_str +  '</a>'
    html_str = html_str +  '</div>'
