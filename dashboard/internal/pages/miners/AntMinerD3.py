...
def main():
    ...
    price = dash_price
    data_ouput = [['1',float(-2999.00),float(0.00),float(float(0.0) * float(price)), float(-2999.00) + float(float(0.00) * float(price))],
                 ['2',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(1))],
                 ['3',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(2))],
                 ['4',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(3))],
                 ['5',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) *float(4))],
                 ['6',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(5))],
                 ['7',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(6))],
                 ['8',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(7))],
                 ['9',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(8))],
                 ['10',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(9))],
                 ['11',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(10))],
                 ['12',float(0.00),float(3.5),float(float(3.5) * float(price)), float(-2999.00) + float(float(3.5) * float(price) * float(11))],
                 ]
    html_str = '<br>'
    ...
    html_str = html_str + '<div class="col-xs-6">'
    daily = (float(3.5) * float(price) / float(31))
    html_str = html_str + '<td>' +  str( float(2999.00)/ daily ) + '</td>'
    html_str = html_str + '</div>'
    html_str = html_str + '</div>'
